...
export function GameCard({ game }: GameCardProps) {
	return (
		<Link href={`/games/${game.id}`} className="block">
			<div className="group relative overflow-hidden rounded-2xl bg-linear-to-br from-zinc-950/95 to-black p-6 shadow-xl backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(50,50,50,0.4)]">
				{/* Borda lineare */}
				...
				<div className="relative z-10">
					...
					{/* Score */}
					<div className="flex items-center justify-center gap-4 rounded-xl bg-linear-to-r from-zinc-950/80 to-black/80 px-6 py-4 backdrop-blur-sm">
