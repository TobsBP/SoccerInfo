    ...
    <footer className="w-full border-t border-zinc-800/50 bg-linear-to-r from-zinc-950 via-black to-zinc-950 backdrop-blur-xl">
      <div className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                aria-label="Twitter"
              >
                <svg className="h-5 w-5 text-zinc-500 transition-colors group-hover:text-zinc-300" fill="currentColor" viewBox="0 0 24 24">
                  <title>Twitter</title>
          ...
          {/* Links Rápidos */}
          <div>
            <h3 className="mb-4 text-sm font-bold text-zinc-300">{t('quickLinks')}</h3>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/teams" className="text-sm text-zinc-500 transition-colors hover:text-zinc-300">
                  {t('teams')}
                </Link>
              </li>
              <li>
                <Link href="/games" className="text-sm text-zinc-500 transition-colors hover:text-zinc-300">
                  {t('games')}
                </Link>
              </li>
              <li>
          ...
          {/* Suporte */}
          <div>
            <h3 className="mb-4 text-sm font-bold text-zinc-300">{t('support')}</h3>
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-sm text-zinc-500 transition-colors hover:text-zinc-300">
                  {t('documentation')}
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="#" className="text-zinc-600 transition-colors hover:text-zinc-400">
              {t('privacy')}
            </Link>
            <Link href="#" className="text-zinc-600 transition-colors hover:text-zinc-400">
              {t('termsOfUse')}
