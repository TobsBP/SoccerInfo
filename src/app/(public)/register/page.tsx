          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="flex items-start gap-3 text-sm text-zinc-400">
                ...
                <span>
                  Eu aceito os{' '}
                  <button type="button" className="text-zinc-300 transition-colors hover:text-zinc-100">
                    termos de uso
                  </button>
                  {' '}e a{' '}
                  <button type="button" className="text-zinc-300 transition-colors hover:text-zinc-100">
            ...
            <p className="mt-6 text-center text-sm text-zinc-500">
              Já tem uma conta?{' '}
              <Link href="/sing-in" className="font-medium text-zinc-300 transition-colors hover:text-zinc-100">
                Fazer login
              </Link>
            </p>
          </div>
