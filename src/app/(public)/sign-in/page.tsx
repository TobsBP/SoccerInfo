          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <button type="button" className="text-zinc-400 transition-colors hover:text-zinc-200">
                  Esqueci a senha
                </button>
              </div>
            ...
            <p className="mt-6 text-center text-sm text-zinc-500">
              Não tem uma conta?{' '}
              <Link href="/register" className="font-medium text-zinc-300 transition-colors hover:text-zinc-100">
                Criar conta
              </Link>
            </p>
          </div>
