...
import { ArrowLeft, Trophy, MapPin, Calendar, Globe, Building2 } from "lucide-react";
          ...
          <div className="rounded-3xl bg-linear-to-br from-zinc-900/30 to-black p-8 shadow-xl border border-zinc-800/30">
            ...
            <div className="space-y-4">
              <div className="flex justify-between border-b border-zinc-800/50 pb-3">
                ...
                <span className="font-medium text-zinc-300">{team.stadium || "-"}</span>
              </div>
              <div className="flex justify-between border-b border-zinc-800/50 pb-3">
                <span className="text-zinc-500">Colors</span>
                <span className="font-medium text-zinc-300">{team.colors || "-"}</span>
              </div>
              <div className="flex justify-between border-b border-zinc-800/50 pb-3">
          ...
          <div className="rounded-3xl bg-linear-to-br from-zinc-900/30 to-black p-8 shadow-xl border border-zinc-800/30">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-2xl bg-zinc-900/50 p-4 text-center">
                <p className="text-3xl font-black text-zinc-200">{team.titlesTotal}</p>
                <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Total Titles</p>
              </div>
              <div className="rounded-2xl bg-zinc-900/50 p-4 text-center">
                <p className="text-3xl font-black text-zinc-200">{team.titlesLeague}</p>
                <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider">League</p>
              </div>
              <div className="rounded-2xl bg-zinc-900/50 p-4 text-center">
                <p className="text-3xl font-black text-zinc-200">{team.titlesCup}</p>
                <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Cups</p>
              </div>
              <div className="rounded-2xl bg-zinc-900/50 p-4 text-center">
                <p className="text-3xl font-black text-zinc-200">{team.titlesIntl}</p>
                <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider">International</p>
              </div>
            </div>
          </div>
        </div>
