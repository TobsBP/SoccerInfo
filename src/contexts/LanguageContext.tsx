...
const translations = {
	pt: {
		...
		// Footer
		description:
			'Plataforma completa para gerenciamento e acompanhamento dos jogos do Campeonato Brasileiro.',
	...
	en: {
		...
		// Footer
		description:
			'Complete platform for management and tracking of Brazilian Championship games.',
